package com.xiaokun.xiusou.demo6.FullListView;
...
public abstract class NestFullListViewAdapter<T> {
    ...
    public onNestItemClickListener onNestItemClickListener;

    public interface onNestItemClickListener {
        void onItemClick(View view, int position);
    }

    public void setOnNestItemClickListener(onNestItemClickListener listener) {
        this.onNestItemClickListener = listener;
    }
