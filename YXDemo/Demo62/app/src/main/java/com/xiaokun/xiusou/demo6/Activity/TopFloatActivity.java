...
import com.xiaokun.xiusou.demo6.CustomView.DoubleScrollView;
...
public class TopFloatActivity extends BaseActivity
{
    ...
    DoubleScrollView doubleScrollView;
    ...
    {
        return R.layout.activity_top_float;
    }
